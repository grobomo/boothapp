...
async function run() {
  ...
  try {
    ...
    var topicsCount = (timeline.topics_detected || []).length;
    log(`Timeline built: ${timeline.event_count} events (${timeline.click_count} clicks, ${timeline.speech_count} speech), ${topicsCount} topics`);
  } catch (err) {
    ...
    timeline = { event_count: 0, click_count: 0, speech_count: 0, engagement_score: 0, topics_detected: [], timeline: [], duration_seconds: 0 };
  }
